...
* **주장 4** — 이 분리는 분류 과제의 인공물이 아니다. argmax가 없는 초해상(ESPCN ×2)에서도 품질 지표는 6×10⁻⁴ dB 안쪽으로 충실한 반면 출력 픽셀 코드의 6.3~18.2%가 다르다.

각 주장의 한계는 **타당성 위협** 장에 외적·구성·결론·내적으로 나눠 적혀 있습니다 — CIFAR-10 규모, 밀집 출력 신경망은 3층,
반올림 축만 시드 3개, 다중비교 미보정, 외부 비트 일치 검증 범위는 conv·pool·fc.
