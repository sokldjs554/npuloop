...
| MobileNetV2-0.5 ReLU6 (91.01%) | 90.92% (-0.09%p) | 90.95% (-0.06%p) | 91.02% (+0.01%p) | 91.05% (+0.04%p) | 91.00% (-0.01%p) | — | — |
...
| MobileNetV2-0.5 ReLU6 | npu-default | 무작위 | -0.05 ± 0.05 | 0.04 ± 0.06 | — | — | — |
| MobileNetV2-0.5 ReLU6 | npu-default | 균형 | — | -0.03 ± 0.00 | — | — | — |
