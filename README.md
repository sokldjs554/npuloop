...
|---|---|---|---|---|---|---|---|
| ResNet-20 ReLU (90.47%) | 90.51% / 90.48% | 90.52% / 90.85% | 90.50% / 90.70% | 90.52% / 90.52% | 90.50% / 90.90% | 90.53% / 90.90% | 90.70% / 91.05% |
...
| `tflite-m31-acc32-b16` | 82.85% / 86.2% | — |
| `tflite-m31-acc32-b12` | 9.75% / 10.0% | — |
| `tflite-m31-acc24-b32` | 91.00% / 100.0% | — |
| `tflite-m31-acc20-b32` | 91.00% / 100.0% | — |
| `tflite-m31-acc16-b32` | 52.80% / 54.4% | — |
